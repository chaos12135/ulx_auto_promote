...
local num = xlib.makeslider{ parent=panel, label="Choose an hour to apply this rank.", x = 315, y = 75, decimal = 0, min= -1, max = 1000, value= -1, w = 250, h = 20, textcolor=color_black}
local dlist = xlib.makelistview{ x=145, y=5, w=150, h=321, parent=panel }
...
net.Receive( "doApShinys", doApShinys )
